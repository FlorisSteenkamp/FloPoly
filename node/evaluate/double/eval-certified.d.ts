 ...
 * * this version does not also return the error; use
 * `evalK1MultiWithErrBoundsInclError` if the error should also be returned
 *
 ...
 */
declare function evalCertified(p: number[][], x: number, pE?: number[], multiplier?: number): number;
