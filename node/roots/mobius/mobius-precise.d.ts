 ...
 * @internal
 */
declare function mobiusAndNumSignChanges(p: number[], p_: number[], pDd: number[][], pDd_: number[], getPExact: () => number[][]): (a: number, b: number, A: number, B: number, failCount: number) => number;
declare function eMobiusAndNumSignChanges(getPExact: () => number[][], a: number, b: number, A: number, B: number): number;
