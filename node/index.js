...
toCasStr, 
// basic bigint
bAbsCoeff, bAdd, bDegree, bDivideByConst, bEqual, bInvert, bIsRationalMultipleOf, bMultiply, bMultiplyByConst, bNegate, bRemoveLeadingZeros, bSubtract, 
// basic double
absCoeff, add, degree, divideByConst, equal, invert, isRationalMultipleOf, multiply, multiplyByConst, negate, removeLeadingZeros, subtract, 
// basic expansion
eAbsCoeff, eAdd, eDegree, eEqual, eInvert, eIsConstOrZero, eIsRationalMultipleOf, eIsUnit, eMultiply, eMultiplyByConst, eNegate, eProduct, eRemoveLeadingZeros, eSubtract, 
// calculus bigint
bDifferentiate, 
// calculus double
differentiate, 
...
eDifferentiate, 
// change variables bigint
bChangeVariablesLinear, bChangeVariablesScale, bChangeVariablesTranslateX, bReflectAboutYAxis, 
// change variables double
changeVariablesLinear, changeVariablesScale, changeVariablesTranslateX, reflectAboutYAxis, 
// change variables expansion
eChangeVariablesLinear, eChangeVariablesScale, eChangeVariablesTranslateX, eReflectAboutYAxis, 
// error analysis
conditionNumber, γ, γγ, 
// euclidean division related bigint
bPdivTrivial, bPremSequencePrimitive, bPremSequenceSubresultant, bPremSequenceTrivial, bSturmChain, 
// euclidean division related double
premSequenceSubresultant, sturmChain, 
// euclidean division related expansion
ePdivTrivial, ePremSequencePrimitive, ePremSequenceSubresultant, eSturmChain, 
// evaluate bigint
bHorner, bEvaluateAt0, bEvaluateAt1, 
// evaluate double
...
// factor expansion
eContent, ePrimitivePart, 
// norm bigint
bP1Norm, bP2NormSquared, bPInfNorm, 
// norm double
p1Norm, p2Norm, pInfNorm, 
// norm expansion
eP1Norm, eP2Norm, ePInfNorm, 
// predictive random double
flatRoots, flatRootsArr, flatCoefficients, flatCoefficientsArr, predictiveRandom, 
// predictive random bigint
bFlatRoots, bFlatRootsArr, bFlatCoefficients, bFlatCoefficientsArr, 
// roots certified
allRootsCertified, allRootsCertifiedSimplified, refineK1, mid, createRootExact, rootIntervalToExp, 
// roots descartes bigint
bNumRoots, bNumRootsIn01, bNumRootsInRange, bSignChanges, 
// roots descartes double
numRoots, numRootsIn01, numRootsInRange, signChanges, 
// roots descartes expansion
eNumRoots, eNumRootsIn01, eNumRootsInRange, eSignChanges, 
// roots from roots
...
// scale to int
scaleFloatToInt, scaleFloatsToInts, scaleFloatssToIntss, scaleFloatToBigint, scaleFloatsToBigints, scaleFloatssToBigintss, 
// gcd bigint
bGcdPrs, bGcdInt, bGcdInts, 
// gcd double
//gcdPrs,
gcdInt, gcdInts, 
// gcd expansion
