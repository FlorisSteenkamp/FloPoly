...
describe('bGcdModular', function() {
    ...
    function() {
...

        {
            ...
            let gcd1 = bGcdModular(p1,p2);
            let gcd2 = bGcdModular(p2,p1);
