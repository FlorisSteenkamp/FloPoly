...
describe('eMultiply', function() {
    ...
    function() {
        ...
        let p3 = [[1],[2],[3]];
        let p4 = [[4],[4],[5],[6],[7]];
        expect(eEqual(eMultiply(p1,p3), [[2],[4],[6]])).toEqual(true);
        expect(eEqual(eMultiply(p2,p3), [])).toEqual(true);
        expect(eEqual(eMultiply(p3,p4), [[4], [12], [25], [28], [34], [32], [21]])).toEqual(true);
    });
});