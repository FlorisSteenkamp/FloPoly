import { ddMultDouble2 as ddMultD } from "double-double";
...
function inplaceDdScale(
    ...
    let sPow = s;
    for (let i=1; i<=n; i++) {
        p[n - i] = ddMultD(sPow, p[n - i]);
        sPow *= s;
    }
}


export { ddScale, inplaceDdScale }
