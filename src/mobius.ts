 ...
 * M(x) = (ax + b) / (cx + d) represented as [[a,b],[c,d]]
 */
function invert(mobius: number[][]): number[][] {
	let [[a, b],[c, d]] = mobius;
 ...
 * M(x) = (ax + b) / (cx + d) represented as [[a,b],[c,d]]
 */
function evaluateAt0(mobius: number[][]): number {
 ...
 * M(x) = (ax + b) / (cx + d) represented as [[a,b],[c,d]]
 */
function evaluateAtInf(mobius: number[][]): number {
 ...
 */
function evaluate(mobius: number[][], x: number): number {
	let [[a, b],[c, d]] = mobius;
